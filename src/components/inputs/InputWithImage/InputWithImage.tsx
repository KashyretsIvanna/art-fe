...
function InputWithImage({
    data, setData, placeholder, img, isError, imgHEight, imgWidth, type, marginTop, marginLeft
}: { img: string, marginTop: string, marginLeft: string, type: 'text' | 'password', imgHEight: string, imgWidth: string, isError: boolean, data: string, setData: React.Dispatch<React.SetStateAction<string>>, placeholder: string }) {
